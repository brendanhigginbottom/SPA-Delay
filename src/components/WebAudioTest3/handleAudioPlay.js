...
const handleAudioPlay = async (audioRef, color, filter, mix, feedback, input, time, scale, volume) => {
    ...
    // create delay
    delay = await device(audioContext, color, filter, mix, feedback, input, time, scale, volume);
    console.log(device);
